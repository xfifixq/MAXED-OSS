...
export default function SettingsPage() {
  ...
  const tools: ToolStatus[] = [
    { name: 'Paperless-ngx', url: process.env.NEXT_PUBLIC_PAPERLESS_URL || 'http://localhost:8000', envVar: 'NEXT_PUBLIC_PAPERLESS_URL', connected: true },
    { name: 'Invoice Ninja', url: process.env.NEXT_PUBLIC_INVOICE_NINJA_URL || 'http://localhost:8080', envVar: 'NEXT_PUBLIC_INVOICE_NINJA_URL', connected: true },
    { name: 'DocuSeal', url: process.env.NEXT_PUBLIC_DOCUSEAL_URL || 'http://localhost:3003', envVar: 'NEXT_PUBLIC_DOCUSEAL_URL', connected: true },
    { name: 'Metabase', url: process.env.NEXT_PUBLIC_METABASE_URL || 'http://localhost:3002', envVar: 'NEXT_PUBLIC_METABASE_URL', connected: true },
    { name: 'n8n', url: process.env.NEXT_PUBLIC_N8N_URL || 'http://localhost:5678', envVar: 'NEXT_PUBLIC_N8N_URL', connected: true },
    { name: 'Mattermost', url: process.env.NEXT_PUBLIC_MATTERMOST_URL || 'http://localhost:8065', envVar: 'NEXT_PUBLIC_MATTERMOST_URL', connected: false },
    { name: 'Kimai', url: process.env.NEXT_PUBLIC_KIMAI_URL || 'http://localhost:8001', envVar: 'NEXT_PUBLIC_KIMAI_URL', connected: true },
    { name: 'Twenty CRM', url: process.env.NEXT_PUBLIC_TWENTY_URL || 'http://localhost:3004', envVar: 'NEXT_PUBLIC_TWENTY_URL', connected: false },
  ];
