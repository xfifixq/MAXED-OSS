...
export default function DashboardHome() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        // Use placeholder data if API is unavailable
        setStats({
          totalClients: 24,
          activeWorkflows: 8,
          pendingInvoices: 12,
  ...
  const quickActions = [
    { label: 'Add Client', href: '/dashboard/clients', icon: '👤', color: 'bg-blue-50 text-blue-600 hover:bg-blue-100' },
    { label: 'Upload Document', href: '/dashboard/documents', icon: '📄', color: 'bg-green-50 text-green-600 hover:bg-green-100' },
    { label: 'Create Invoice', href: '/dashboard/invoicing', icon: '💰', color: 'bg-yellow-50 text-yellow-600 hover:bg-yellow-100' },
    { label: 'Run Scenario', href: '/dashboard/advisory', icon: '💡', color: 'bg-purple-50 text-purple-600 hover:bg-purple-100' },
  ];
